...
public class Main {
    ...
    private static void task1() {
                ...
                recursiveTriangleSequence(1, n, 1);
            }

            private static void recursiveTriangleSequence(int current, int n, int i) {
                if (i > n) {
                    System.out.println();  // Переход на новую строку после завершения последовательности
                    return;
                }

                if (current <= n) {
                    System.out.print(current + " ");
                    recursiveTriangleSequence(current + 1, n, i);
                } else {
                    recursiveTriangleSequence(1, n, i + 1);
                }
            }
    ...
    private static void recursiveCountUp(int current, int n) {
        if (current <= n) {
            System.out.print(current + " ");
            recursiveCountUp(current + 1, n);
        }
    }
    ...
    private static void recursiveRange(int A, int B) {
        if (A <= B) {
            System.out.print(A + " ");
            recursiveRange(A + 1, B);
        } else {
            System.out.println();  // Переход на новую строку после завершения последовательности
        }
    }
